...
export default function Footer() {
  return (
    <footer
      className="relative z-[1] px-6 pb-8 pt-12 md:px-16 md:pt-16"
      style={{ background: "var(--ink)", color: "var(--cream-dark)" }}
    >
      {/* ── Three columns — stack on mobile, side by side on md+ ── */}
      <div
        className="mb-8 grid gap-8 border-b pb-8 md:mb-12 md:gap-16 md:pb-12"
        style={{
      ...
      >
        ...
        <div>
          ...
          >
            Antique and vintage linens, textiles, and curiosities. A
            Georgetown institution since 1994.
          </p>
        </div>
